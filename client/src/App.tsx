  ...
  const joinRoom = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center text-white bg-[url(/src/assets/bg_cubitochat.png)] bg-cover bg-center px-8">
            {!showChat ? (
                <div className="w-fit flex flex-col justify-center items-center text-center space-y-2 bg-gray-500/80 backdrop-blur-sm rounded-xl py-8 px-4">
                    ...
                    <button
                        onClick={joinRoom}
                        className="p-2 bg-cyan-950 hover:bg-cyan-300 rounded-md font-medium w-[300px]"
                    >
                        Join a Room
                    </button>
                </div>
